...
.. note::
   The font families are from `Google fonts <https://fonts.google.com/>`_ or you can add your own
   :ref:`fonts <theming/module/variables/fonts/custom>`.
...
.. spoiler:: Solutions
   ...
   #. Declare the 2 files you just created in the :file:`__manifest__.py` as indicated in the
      documentation.

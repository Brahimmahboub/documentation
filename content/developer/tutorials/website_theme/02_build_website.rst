...
.. seealso::
   ...
   :ref:`website_themes/building_blocks/layout/grid`.
...
- Add the `Airproof logo
  <{GITHUB_TUTO_PATH}/website_airproof/static/src/img/content/branding/airproof-logo.svg>`_. In the
...
.. seealso::
   - See how to set up the :ref:`theming/module/website` (including the logo).
...
.. note::
   ...
   - It could be interesting to put a :ref:`website_themes/pages/theme_pages/noupdate` on the
     navigation so the changes made later by your client won’t be overwritten if you have to update
     the module.
...
.. spoiler:: Solutions
   ...
   - declare your :file:`website.xml` in your :file:`__manifest__.py`.
   - create your menu as in the `menu.xml <{GITHUB_TUTO_PATH}/website_airproof/data/menu.xml>`_ from
     our Airproof example.
